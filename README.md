...
*   修复：内置 MD 阅读器的分卷切换加载，新增分卷下拉菜单、上一卷下一卷按钮。（2026年3月14日）
*   修复：Windows 系统休眠唤醒后，程序无法执行调用后端工具指令的错误，现在会自动提示刷新。 （2026年3月13日）
*   修复：论坛内置表情包图片外链显示错误。（2026年3月13日）
*   新增：“查看楼主NGA用户信息”跳转链接（2026年3月13日）
*   新增：github 仓库地址跳转按钮（2026年3月13日）
*   新增：更新后进度增量显示（2026年3月13日）

## 主要功能

*   **订阅管理**：支持添加、删除、搜索 NGA 帖子订阅。
*   **智能存档**：自动扫描本地存档，智能解析 Markdown 文件头部的标题和楼主信息，修复纯数字文件夹显示问题。
*   **自动更新**：设置自动更新计划，定时检查订阅帖是否有新内容，支持同时最多5个自动更新计划。
*   **本地预览**：内置简易 Markdown 阅读器，支持直接预览存档内容，包含图片灯箱浏览模式。
